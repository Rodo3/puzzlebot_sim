...
def generate_launch_description():
    ...
    arg_remappings_en = DeclareLaunchArgument('remapping', default_value='false',description='In case we want to use the stack in gazebo')
    ...
    remapping = LaunchConfiguration('remapping')
    ...
    steering_controller = Node(
        ...
        remappings=[('/cmd_vel_in', '/cmd_vel_steering')] if remapping == False else [],
        # remappings=[('/cmd_vel_in', '/cmd_vel_steering')] if remapping == False else [('/cmd_vel_in', '/model/puzzlebot/cmd_vel')],
        output='screen',
